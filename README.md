...
Harmonized data serving as the dataset to demo the software/code for Mendelian randomization (MR) can be found in Supplementary Table 3,8,10,13.
Expected MR output can be found in Supplementary Table 4,9,11,14 (main analyses) and 5,12,15 (sensitivity analyses).
