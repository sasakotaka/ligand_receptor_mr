...
file <- 'outco_dat_BladderCancer_formatted.txt'
outco_BladderCancer_dat <- vroom(file, col_names = TRUE)

wbc_list <- "BladderCancer"
wbc_N <- effective_n(4852+2590, 378749+415431)
...
dat_all$samplesize.outcome <- wbc_N
